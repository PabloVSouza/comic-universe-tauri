...
import {
  HorizontalReader,
  type HorizontalReaderSlide,
  ReaderBottomBar,
  ReaderTopBar,
  ReaderZoomWindow,
  VerticalReader
} from 'components/TemplateComponents/Reader'
...
export const Reader: FC = () => {
  ...
  useEffect(() => {
    if (readingMode !== 'vertical' || !verticalScrollContainerNode || !readProgress || !pages.length) return
  ...
  return (
    ...
    >
      {isMobileViewport ? (
        ...
        <div
          className={`pointer-events-none absolute inset-x-0 top-0 z-30 transition-all duration-300 ${
